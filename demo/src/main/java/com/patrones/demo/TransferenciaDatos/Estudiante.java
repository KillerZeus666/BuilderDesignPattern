...
import com.patrones.demo.patronbuilder.InterfaceBuilder;
...
public class Estudiante {
    ...
    public List<Telefonos> getTelefonos() { return telefonos; }
    public void setTelefonos(List<Telefonos> telefonos) { this.telefonos = telefonos; }

    public List<Contactos> getContactos() { return contactos; }
    public void setContactos(List<Contactos> contactos) { this.contactos = contactos; }
    ...
    public static class EstudianteBuilder implements InterfaceBuilder<Estudiante> {
        ...
        public EstudianteBuilder setPrograma(String nombre, int numeroSemestres) {
